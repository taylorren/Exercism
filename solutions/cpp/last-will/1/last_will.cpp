...
{
    int assemble_account_number(int modifier)
    {
        return zhang::bank_number_part(modifier)+khan::bank_number_part(modifier)+garcia::bank_number_part(modifier);
    }

    int assemble_code()
    {
        int sumRedCodes = zhang::red::code_fragment() + khan::red::code_fragment() + garcia::red::code_fragment();
        int sumBlueCodes = zhang::blue::code_fragment() + khan::blue::code_fragment() + garcia::blue::code_fragment();
        return sumRedCodes * sumBlueCodes;
    }

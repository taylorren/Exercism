...
export function onSuccess() {
  notify({ message: 'SUCCESS' }); // implement the onSuccess callback to call notify with a success message
}
...
export function onError() {
  notify({ message: 'ERROR' });  // implement the onError callback to call notify with an error message
}
